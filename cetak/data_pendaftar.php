...
<img src="../assets/img/logo.JPG" style="float: left; height: 60px">

<div style="margin-left: 20px">
    <div style="font-size: 18px">Data Pendaftaran Siswa Baru | TAHUN 2023</div>
    <div style="font-size:20px">SMP Al Khairiya Ory </div>
    <div style="font-size: 12px">Dusun Pelauw, kecamatan Pulau HaruKU, kabupaten Maluku Tengah 68472</div>
</div>
