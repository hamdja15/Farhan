...
<head>
  ...
  <meta name="description" content="Aplikasi pendaftaran Siswa SMP AL KHAIRIYAH.">
              ...
              <div class="col-md-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="assets/img/logo.jpg" alt="Logo sekolah" class="logo-login">

                    <h1 class="h4 text-gray-900">Aplikasi Pendaftaran Siswa</h1>
                    <h1 class="h4 text-gray-900 mb-4"><b>SMP AL KHAIRIYAH ORY</b></h1>
