              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Terima kasih telah melakukan pendaftaran di SMP AL KHAYRIAYH ORY . Pengumuman pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">18 Mei 2023</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMP AL KHAIRYAH ORY</marquee>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Selamat anda lolos seleksi di SMP AL KHAYRIAYH ORY. Lakukan Daftar Ulang pada tanggal: </p>
                    <span class="badge badge-danger" style="font-size: 20px;">20 agustus 2023</span>
                  </div>
                  <div class="card-footer text-muted">
                    <marquee style="margin-bottom: -5px;">SMP AL KHAYRIAYH ORY</marquee>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <p class="text-danger mt-3">* Wajib melakukan Daftar Ulang pada tanggal: 20 Agustus 2023</p>
            </div>
          </div>
        </div>
